...
function TrackTableRow(props) {
	...
	return (
		<tr>
			<td><Link to={ '/track?id=' + props.info.id } className="inner-link">{props.info.name}</Link></td>
			<td><Link to={ '/album?id=' + props.info.album.id } className="inner-link">{props.info.album.name}</Link></td>
